...
for _data_name in ['PlantCAMO1250']:
    ...
    polarization_root = '{}/polarization/'.format(data_path)
    gt_root = '{}/gt/'.format(data_path)
    print('root',image_root,polarization_root,gt_root)
    test_loader = My_test_dataset(image_root, polarization_root, gt_root, opt.testsize)
    ...
    for i in range(test_loader.size):
        ...
        _, P2 = model(image,polarization_image)
        # P2 = model(image)
